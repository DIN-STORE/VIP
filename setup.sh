...
TIMES="10"
CHATID="6452266025"
KEY="8117724992:AAGmiDDDM_qf_U1I5Gv8xGbyovkrWCiQ2V4"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SRICPT BY DINSTORE              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Din-store/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Din-store/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Din-store/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Din-store/vip/main/"
start=$(date +%s)
secs_to_human() {
...
echo "DIN STORE" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Din-store/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Din-store/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/Din-store/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/Din-store/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/Din-store/vip/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/Din-store/vip/main/Cfg/m-noobz 
